...
import com.crio.rentRead.services.ImplUserDetailsService;
...
public class SecurityConfig {
    ...
    @Bean
    public UserDetailsService userDetailsService(IUserRepositoryService userRepositoryService) {
        return new ImplUserDetailsService(userRepositoryService);
    }
